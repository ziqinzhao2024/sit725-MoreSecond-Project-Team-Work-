...
//This code uses jQuery and runs when the document is ready. It defines a function called fetchFun that sends an HTTP request to the specified URL,
// which can handle GET or POST requests, and processes the JSON data returned by the server.

//Next, a function called getCommodity is defined to get a list of products in a specific category (in this case, "Luxury"). 
//It sends a GET request to the server for a list of commodities of a specific category.
